...
class HiddenFeeDetector:
    ...
    def analyze(
        ...
        if quote.deposit is not None:
            total = quote.comparable_total or quote.negotiated_total or quote.original_total
            if total and quote.deposit * Decimal("100") / total > self._large_deposit_percent:
                findings.append(
                    self._finding(
                        quote,
