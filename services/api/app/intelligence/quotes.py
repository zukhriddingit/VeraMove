...
class QuoteNormalizer:
    ...
    def normalize(self, quote: QuoteV1) -> QuoteV1:
        ...
        spoken_total = quote.negotiated_total or quote.original_total
        ...
        return quote.model_copy(
            update={
                "original_total": quote.original_total or itemized_total,
                "negotiated_total": quote.negotiated_total or itemized_total,
...
class QuoteVerifier:
    ...
    def verify(
        ...
        provisional_by_category = {item.category: item for item in provisional_quote.fee_line_items}
        transcript_by_category = {item.category: item for item in transcript_facts.fee_line_items}
        contradictions: list[str] = []
        merged: list[FeeLineItem] = []

        for category in dict.fromkeys([*provisional_by_category, *transcript_by_category]):
            provisional = provisional_by_category.get(category)
            supported = transcript_by_category.get(category)
        ...
        verified = provisional_quote.model_copy(
            update={
                ...
                "original_total": transcript_facts.spoken_total or itemized_total,
                "negotiated_total": transcript_facts.spoken_total or itemized_total,
                "comparable_total": comparable_total,
                ...
                "verified_data": {
                    **provisional_quote.verified_data,
                    ...
                    "contradicted_fee_categories": contradictions,
